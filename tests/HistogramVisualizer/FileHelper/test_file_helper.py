...
class TestFileHelper(unittest.TestCase):
    ...
    def setUp(self):
        self.testFile = os.path.join(rootPath, 'tests/HistogramVisualizer/FileHelper/data.json')
        pass
    ...
    def test_writeJsonFile_not_exists(self):
        outputFile = os.path.join(rootPath, 'tests/HistogramVisualizer/FileHelper/test.json')
        jsonData = {
            'test' : 'rendezvous'
        }
    ...
    def test_readJsonFile_not_exists(self):
        readFile = os.path.join(rootPath, 'tests/HistogramVisualizer/FileHelper/notExists.json')
    ...
    def test_readJsonFile_exists(self):
        readFile = os.path.join(rootPath, 'tests/HistogramVisualizer/FileHelper/test.json')
        data = {
            'test2' :  42
        }
    ...
    def test_readJsonFile_not_json(self):
        readFile = os.path.join(rootPath, 'tests/HistogramVisualizer/FileHelper/test.txt')
        data = 123423545435
        FileHelper.writeJsonFile(readFile, data)
        try: 
            FileHelper.readJsonFile(readFile)
