#include "CpuDarknetFisheyeDewarper.h"
...
void CpuDarknetFisheyeDewarper::dewarpImage(const Image& src, const ImageFloat& dst, const DewarpingParameters& params) const
{
    ...
    {
        Point<float> srcPosition = dewarping::calculateSourcePixelPosition(dst, params, index);
        int srcIndex = dewarping::calculateSourcePixelIndex(srcPosition, src);
...
void CpuDarknetFisheyeDewarper::dewarpImageFiltered(const Image& src, const ImageFloat& dst, const DewarpingParameters& params) const
{
    ...
    {
        Point<float> srcPosition = dewarping::calculateSourcePixelPosition(dst, params, index);
        LinearPixelFilter linearPixelFilter = dewarping::calculateLinearPixelFilter(srcPosition, src);
