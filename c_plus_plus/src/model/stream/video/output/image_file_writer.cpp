...
#include "model/stream/utils/images/stb/stb_image_write.h"
...
void ImageFileWriter::writeImage(const Image& image)
{
    ...
    stbi_write_png((folder_ + "/" + imageName_ + ".png").c_str(), outputImage.width, outputImage.height, 3,
                   outputImage.hostData, 0);
}
}    // namespace Model
